    ...
    val personal get() = _personal
        ...
        fun updateProfile() {
            viewModelScope.launch {
                updatePersonalUseCase.execute(UpdatePersonalUseCase.Params(id.value?:"",name.value?:"", dni.value?:"", nationality.value?:"", organization.value?:"", position.value?:"", twitter.value?:"", facebook.value?:"", linkedin.value?:"", phone.value?:""))
